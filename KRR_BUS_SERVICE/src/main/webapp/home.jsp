...
<body>
        ...
        <div class="nav">
            <a href="canceling.jsp" target="_blank"><h3 class="Cancelling">Cancelling</h3></a>
            <a href="TICKET INFO.html" target="_blank"><h3 class="Ticket_Info">Ticket Info</h3></a>
            <a href="" target="_blank"><h3 class="Contact">Contact</h3></a>
            <a href="index.jsp" target="_blank"><h3 class="Logout">Logout</h3></a>
        </div>
        <div>
    ...
    <div class="serachbox">
        ...
        <div class="serachboxform">
            <form action="businfo" method="post" target="_blank">
                <input class="input1"  type="text" name="fromaddress" placeholder="From" required>
                <input class="input2" type="text" name="toaddress" placeholder="To" required>
                <input class="input3" type="date" min="<%= nowdate %>" max="<%=lastdate %>" name="date" placeholder="date" required>
                <button class="input4">Search Buses</button>
            </form>
        </div>
    </div>
